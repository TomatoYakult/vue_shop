  ...
  <div>
    ...
    <el-card>
      ...
      <el-table :data="orderList" border stripe>
        ...
        <el-table-column align="center" prop="order_price" label="订单价格" width="120"></el-table-column>
  ...
  export default {
    ...
    methods: {
      async getOrderList() {
        ...
        if (res.meta.status !== 200) return this.$message.error('获取订单列表失败，请尝试刷新页面！');
      ...
      async showProgressBox() {
        const { data: res } = await this.$http.get('/kuaidi/75371307979457');
